...
下图把这条主链按 `Caller / AsyncLLM Frontend / IPC Transport / EngineCore Backend` 四个区域重新展开，阅读时可以重点关注“请求提交”和“流式返回”两条方向相反的链路：

![vLLM Engine 核心代码流程图](image/ch02-引擎模块和流式执行/engine-core-flow.png)
